...
namespace BootstrapSupport
{
    public static class DefaultScaffoldingExtensions
    {
        ...
        public static PropertyInfo[] VisibleProperties(this IEnumerable Model)
        {
            ...
            return elementType.GetProperties().Where(info => info.Name != elementType.IdentifierPropertyName() && info.PropertyType.AttributeExists<System.ComponentModel.DataAnnotations.BindableTypeAttribute>()).ToArray();
        }

        public static PropertyInfo[] VisibleProperties(this Object model)
        {
            return model.GetType().GetProperties().Where(info => info.Name != model.IdentifierPropertyName() && info.PropertyType.AttributeExists<System.ComponentModel.DataAnnotations.BindableTypeAttribute>()).ToArray();
        }
        ...
        public static IEnumerable BindablePropertyName(this Type type)
        {
            return type.GetProperties().Where(info => info.PropertyType.AttributeExists<System.ComponentModel.DataAnnotations.BindableTypeAttribute>());
        }
